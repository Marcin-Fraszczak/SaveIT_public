...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function (a, h, g) {
...
(function (a) {
    ...
    function l(b) {
        0 !== a(b).find(".nav-tabs").length && a(b).outerFind('section[id^="tabs"]').each(function () {
            var b =
                a(this).attr("id"), d = a(this).find(".nav-tabs .nav-item"), f = a(this).find(".tab-pane");
    ...
    a.fn.footerReveal = function () {
        function b() {
            !e && c.outerHeight() <= f.outerHeight() ? (c.css({
                "z-index": -999,
                position: "fixed",
                bottom: 0
        ...
        var c = a(this), d = c.prev(), f = a(window), e = !!document.documentMode;
        b();
    ...
    a(function () {
        ...
        a.isMobile() && navigator.userAgent.match(/Chrome/i) ? function (b, c) {
            ...
            q || (a(window).smartresize(function () {
        ...
        var f, m, g = 0, k = null, h = !a.isMobile();
        a(window).scroll(function () {
            m && clearTimeout(m);
            var b = a(window).scrollTop(), c = b <= g || h;
            g = b;
            if (k) {
        ...
        a(".cols-same-height .mbr-figure").each(function () {
            ...
            var c = a(this), d = c.children("img"), f = c.parent(), e = d[0].width,
                m = d[0].height;
            d.one("load", function () {
                e = d[0].width;
                m = d[0].height;
            ...
            if (!a.isMobile() &&
                ...
                var d = a("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .mbr-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-social, .mbr-figure, .mbr-map, .mbr-testimonial .card-block, .mbr-price-value, .mbr-price-figure, .dataTable, .dataTables_info").not(function () {
                    ...
                    return a(this).parents().is("form") &&
                        a(this).is("li")
                }).addClass("hidden animate__animated animate__delay-1s"), f = a(window);
                f.on("scroll resize", function () {
                    var f = document.documentElement.scrollTop || document.body.scrollTop,
                        e = f + window.innerHeight - 100;
                    a.each(d, function () {
                        var d = a(this), g = d[0], h = g.offsetHeight;
                        g = c(g);
                        if ((g + h >= f && g <= e || b(d)) && d.hasClass("hidden")) d.removeClass("hidden").addClass("animate__fadeInUp animate__delay-1s").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
    ...
    a(document).ready(function () {
        if (!e) {
            var b = function (b) {
                var c = a(b).parents("section").find("iframe")[0], f = a(c).attr("src");
                b.parents("section").css("z-index", "5000");
                -1 !== f.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*");
    ...
    if (!e && !a.isMobile()) {
        ...
        !p.find(".navbar").hasClass("collapsed") && 991 < r && (p.find("ul.navbar-nav li.dropdown").hover(function () {
            a(this).hasClass("open") || a(this).find("a")[0].click()
        }, function () {
            a(this).hasClass("open") && a(this).find("a")[0].click()
        }), p.find("ul.navbar-nav li.dropdown .dropdown-menu .dropdown").hover(function () {
    ...
    })), "undefined" === typeof window.initPopupBtnPlugin && 0 != a(document.body).find("section.popup-btn-cards").length && (window.initPopupBtnPlugin =
        !0, a("section.popup-btn-cards .card-wrapper").each(function (b, c) {
...
!function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.innerHTML = '<a href="https://mobirise.in">Mobirise HTML Web Page Maker</a> Mobirise v5.0.29';
